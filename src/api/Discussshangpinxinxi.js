...
export default ({ config, db }) => {
	...
	api.get('/group/:columnName', async (req, res) => {
		...
		try {
			...
			let where = " WHERE 1 = 1 "
			sql = "SELECT COUNT(*) AS total, " + columnName + " FROM discussshangpinxinxi " + where + " GROUP BY " + columnName 
	...
	api.get('/value/:xColumnName/:yColumnName', async (req, res) => {
		...
		try {
			...
			sql = "SELECT " + xColumnName + ", SUM(" + yColumnName + ") AS total FROM discussshangpinxinxi " + where + " GROUP BY " + xColumnName + " DESC"
