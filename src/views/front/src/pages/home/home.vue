...
<div id="animate_recommendshangpinxinxi" class="recommend animate__animated" :style='{"padding":"60px 0 60px","margin":"40px auto 20px","borderColor":"#ddd","background":"#f1f1f1","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
    ...
    <div class="title" :style='{"width":"76%","padding":"60px 0 0","margin":"0px auto","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231010/f0b8580773a548e68d6b92e646873f96.png) no-repeat left top / auto 42px","height":"120px"}'>
		<span :style='{"padding":"0","fontSize":"24px","color":"#000","fontWeight":"500","display":"block"}'>商品信息推荐</span>
	</div>
...
<!-- 特价商品 -->
<div id="animate_listgonggaoxinxi" class="lists animate__animated" :style='{"width":"100%","padding":"40px 0 60px","margin":"0px auto 20px","position":"relative","background":"#fff","order":"3"}'>
	...
	<div class="title" :style='{"width":"76%","padding":"60px 0 0","margin":"0px auto","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231010/da413089b74c43f09da07e605b455341.png) no-repeat left top / auto 52px","height":"90px"}'>
	  <span :style='{"padding":"0","fontSize":"24px","color":"#000","fontWeight":"500","display":"block","font":"\"宋体\""}'>公告信息展示</span>
	</div>
