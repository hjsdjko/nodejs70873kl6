...
<div class="content" :style='{"minHeight":"100vh","padding":"20px 20px 30px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230805/a0d58222f2a44e148bf030fbb779c936.png) no-repeat center top / cover","display":"flex","fontSize":"16px","height":"100%"}'>
	...
	<div :style='{"padding":"10px 10px 0","boxShadow":"0 1px 3px 0px rgba(115,108,203,.23)","margin":"0 30px 30px 30px","borderColor":"#fceaee","alignItems":"center","color":"#666","display":"flex","justifyContent":"center","borderRadius":"3px","flexWrap":"wrap","background":"#fff","borderWidth":"0px","width":"300px","fontSize":"14px","borderStyle":"double","order":"2"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 0px 10px 0","borderColor":"#f0f0f0","borderRadius":"3px","textAlign":"center","background":"rgba(255, 255, 255,0)","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('yonghu','首页总数')">
		...
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 0px 10px 0","borderColor":"#f0f0f0","borderRadius":"3px","textAlign":"center","background":"none","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('shangpinxinxi','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":"none","justifyContent":"center","display":"flex","height":"83px"}'>
	...
	<!-- echarts -->
	<!-- 3 -->
	<div class="type3" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"flex-start","height":"auto","order":"10"}'>
