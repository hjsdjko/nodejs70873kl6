	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="咨询账号" prop="zixunzhanghao">
					<el-input v-model="ruleForm.zixunzhanghao" placeholder="咨询账号" clearable  :readonly="ro.zixunzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="咨询账号" prop="zixunzhanghao">
					<el-input v-model="ruleForm.zixunzhanghao" placeholder="咨询账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="咨询姓名" prop="zixunxingming">
					<el-input v-model="ruleForm.zixunxingming" placeholder="咨询姓名" clearable  :readonly="ro.zixunxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="咨询姓名" prop="zixunxingming">
					<el-input v-model="ruleForm.zixunxingming" placeholder="咨询姓名" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="咨询问题" prop="zixunwenti">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.zixunwenti" label="咨询问题" prop="zixunwenti">
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zixunzhanghao'){
							this.ruleForm.zixunzhanghao = obj[o];
							this.ro.zixunzhanghao = true;
							continue;
						}
						if(o=='zixunxingming'){
							this.ruleForm.zixunxingming = obj[o];
							this.ro.zixunxingming = true;
							continue;
						}
						if(o=='touxiang'){
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.zhanghao!=''&&json.zhanghao) || json.zhanghao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.zixunzhanghao = json.zhanghao
						this.ro.zixunzhanghao = true;
					}
					if(((json.xingming!=''&&json.xingming) || json.xingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.zixunxingming = json.xingming
						this.ro.zixunxingming = true;
					}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zixunwenti = this.ruleForm.zixunwenti.replace(reg,'../../../nodejs70873kl6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `zixunmaijia/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.zixunmaijiaCrossAddOrUpdateFlag = false;
											this.parent.search();
